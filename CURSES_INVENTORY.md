...
| `mvaddch(y, x, ch)` | `chase.c:88`, `daemons.c:101`, `daemons.c:213`, `daemons.c:254`, `daemons.c:260`, `fight.c:95`, `fight.c:161`, `fight.c:612`, `io.c:~100` (via msg), `main.c:179`, `misc.c:178`, `pack.c:185`, `pack.c:454`, `pack.c:46`, `passages.c:~340`, `rip.c:243`, `rip.c:245`, `rip.c:246`, `rip.c:251`, `rip.c:301`, `rip.c:305` | `level/ffi.rs:583`, `player.rs:390`, `potions.rs:549`, `scrolls.rs:437`, `sticks.rs:404`, `trap.rs:159`, `weapons.rs:243`, `weapons.rs:252`, `weapons.rs:273`, `wizard.rs:259`, `wizard.rs:269` | `execute!(stdout, MoveTo(x,y))` + `print!("{}", ch)` |
...
| Function | C call sites | Rust call sites | crossterm equivalent |
|---|---|---|---|
| `clear()` | `level/ffi.rs:523`, `rip.c:224`, `rip.c:285`, `rip.c:304` | — | `execute!(stdout, Clear(ClearType::All))` |
