...
/*
 * Function types: all gameplay functions have been ported to Rust.
 * Function prototypes below are only those still implemented in C
 * or called from the Rust FFI layer via the C ABI.
 */
void	init_check();
void	open_score();
void	setup();
